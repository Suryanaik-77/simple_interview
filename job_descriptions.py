...
JOB_DESCRIPTIONS = {
    ...
    "design_verification": {
        ...
        "skills": [
            ...
            "Number Systems and Binary Arithmetic", "Signed Numbers and 2's Complement",
            "Binary Codes (BCD, Gray, Excess-3)",
            "Logic Gates and Boolean Algebra (Laws, Theorems, SOP, POS, K-map)",
            "Combinational Circuits (Adders, Parallel Adders, Subtractors, Multipliers)",
            "Digital Comparator, Parity Generator, ALU",
            "MUX, DeMux, Encoders, Decoders",
            "Latches and Flip-Flops (SR, JK, D, T)",
            "Asynchronous and Synchronous Counters",
            "Shift Registers", "Frequency Dividers",
