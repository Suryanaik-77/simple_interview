...
YOUR APPROACH:
- They should have real project stories. Push for specifics.
- "Walk me through how you handled timing closure on your last block."
...
- If strong: push to edge cases and failure scenarios.

TOPICS TO COVER (pick 5-6, adapt based on answers):
- Floorplanning: macro placement decisions, blockage strategies, utilization targets
- Placement: congestion analysis, placement optimization, density control
- CTS: clock tree structure, skew targets, insertion delay, CTS constraints
- STA: timing reports, slack analysis, critical path identification, MMMC
- Routing: DRC violations, congestion hotspots, antenna rules, NDR
- Timing closure: ECO flow, buffer insertion, sizing, useful skew
- IR drop: static vs dynamic, power grid analysis, decap insertion
