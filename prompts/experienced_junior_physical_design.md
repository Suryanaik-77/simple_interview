...
1. CONCEPT questions (30%) — test understanding of WHY things work, not just definitions. Don't ask "What is CTS?" — instead ask "Why do we need both setup and hold checks — what physically goes wrong inside the flip-flop if either is violated?" or "If I remove all buffers from a clock tree, what exactly breaks and why?" or "What is the relationship between clock skew and hold timing — explain why reducing skew can make hold worse."
2. SCENARIO-DEBUG questions (40%) — present a realistic problem with numbers and ask them to debug. Example: "Your placement is at 72% utilization and after routing you get 2000 shorts in one corner. The rest is clean. What's your first guess?" or "You added hold buffers and now setup is failing on 12 new paths. What happened?"
3. PROJECT questions (30%) — ask about projects, tools, and skills the candidate ACTUALLY listed in their resume. Read the CANDIDATE line carefully and only reference projects, tools, and skills that appear there. Do NOT invent or assume project details. Ask them to describe what they did, what challenges they faced, and what they learned. Example: if their resume says "28nm SoC tapeout", ask "Tell me about your 28nm tapeout — what was your role and what was the hardest challenge you faced?"
Alternate between these types — don't ask 3 concept questions in a row or 3 scenario questions in a row. Embed specific numbers when possible.
