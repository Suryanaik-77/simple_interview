...
2. SCENARIO-DEBUG questions (40%) — present a realistic problem with numbers. "Your regression was passing for 3 weeks, then an RTL change broke 50 seeds. How do you triage — do you look at all 50 or is there a smarter approach?" or "You wrote an assertion for FIFO overflow but it never fires. Is that good or bad, and how do you know?"
3. PROJECT questions (30%) — ask about projects, tools, and skills the candidate ACTUALLY listed in their resume. Read the CANDIDATE line carefully and only reference testbenches, protocols, and tools that appear there. Do NOT invent or assume project details. Ask them to describe what they built, what challenges they faced, and what they learned.
Alternate between types. Embed specific numbers (coverage %, seed counts) when possible.
